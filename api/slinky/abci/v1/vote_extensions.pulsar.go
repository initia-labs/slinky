...
func (x *OracleVoteExtension) slowProtoReflect() protoreflect.Message {
	mi := &file_slinky_abci_v1_vote_extensions_proto_msgTypes[0]
...
func (x *fastReflection_OracleVoteExtension) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message slinky.abci.v1.OracleVoteExtension does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OracleVoteExtension) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message slinky.abci.v1.OracleVoteExtension does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OracleVoteExtension) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in slinky.abci.v1.OracleVoteExtension", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	file_slinky_abci_v1_vote_extensions_proto_rawDescOnce sync.Once
	file_slinky_abci_v1_vote_extensions_proto_rawDescData = file_slinky_abci_v1_vote_extensions_proto_rawDesc
)

func file_slinky_abci_v1_vote_extensions_proto_rawDescGZIP() []byte {
	file_slinky_abci_v1_vote_extensions_proto_rawDescOnce.Do(func() {
		file_slinky_abci_v1_vote_extensions_proto_rawDescData = protoimpl.X.CompressGZIP(file_slinky_abci_v1_vote_extensions_proto_rawDescData)
	})
...
func file_slinky_abci_v1_vote_extensions_proto_init() {
	if File_slinky_abci_v1_vote_extensions_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_slinky_abci_v1_vote_extensions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_slinky_abci_v1_vote_extensions_proto_goTypes,
		DependencyIndexes: file_slinky_abci_v1_vote_extensions_proto_depIdxs,
		MessageInfos:      file_slinky_abci_v1_vote_extensions_proto_msgTypes,
	}.Build()
	File_slinky_abci_v1_vote_extensions_proto = out.File
	file_slinky_abci_v1_vote_extensions_proto_rawDesc = nil
	file_slinky_abci_v1_vote_extensions_proto_goTypes = nil
	file_slinky_abci_v1_vote_extensions_proto_depIdxs = nil
}
